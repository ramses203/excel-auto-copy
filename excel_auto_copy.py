...
class ExcelAutoCopyApp:
    ...
    def setup_ui(self):
        ...
        tk.Label(source_frame, text="Source Excel:", width=12, anchor="w").pack(side=tk.LEFT)
        ...
        tk.Label(target_frame, text="Target Excel:", width=12, anchor="w").pack(side=tk.LEFT)
        ...
        tk.Label(repeat_frame, text="Repeat Count (per row):", width=20, anchor="w").pack(side=tk.LEFT)
